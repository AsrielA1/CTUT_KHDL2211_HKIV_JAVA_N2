 ...
 */
package management.views.visualization;

/**
 *
 * @author Asriel
 */
public class VisuallizationJFrame extends javax.swing.JFrame {

    /**
     * Creates new form VisuallizationJFrame
     */
    public VisuallizationJFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisuallizationJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisuallizationJFrame().setVisible(true);
            }
        });
    }
